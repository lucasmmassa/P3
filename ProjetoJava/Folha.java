        ...
        for(int i = 0; i < places; i++){
            if(busyPlaces[i]){
                switch(paymentMethod[i]){
                    case 1:
                        if(syndicated[i]){
                            System.out.print("Register:" + i + " - " + names[i] + " - " + adress[i] + " - Worker type:" + workerType[i] + " - Salary:" + salaries[i] + " - Check by Mail" + " - " + "Syndicated - Register:" + syndicateRegister[i] + "\n");
                        }
                        else{
                            System.out.print("Register:" + i + " - " + names[i] + " - " + adress[i] + " - Worker type:" + workerType[i] + " - Salary:" + salaries[i] + " - Check by Mail" + " - " + "Not syndicated\n");
                        }
                        break;
                    
                    case 2:
                        if(syndicated[i]){
                            System.out.print("Register:" + i + " - " + names[i] + " - " + adress[i] + " - Worker type:" + workerType[i] + " - Salary:" + salaries[i] + " - Check in hands" + " - " + "Syndicated - Register:" + syndicateRegister[i] + "\n");
                        }
                        else{
                            System.out.print("Register:" + i + " - " + names[i] + " - " + adress[i] + " - Worker type:" + workerType[i] + " - Salary:" + salaries[i] + " - Check in hands" + " - " + "Not syndicated\n");
                        }
                        break;

                    case 3:
                        if(syndicated[i]){
                            System.out.print("Register:" + i + " - " + names[i] + " - " + adress[i] + " - Worker type:" + workerType[i] + " - Salary:" + salaries[i] + " - Bank account" + " - " + "Syndicated - Register:" + syndicateRegister[i] + "\n");
                        }
                        else{
                            System.out.print("Register:" + i + " - " + names[i] + " - " + adress[i] + " - Worker type:" + workerType[i] + " - Salary:" + salaries[i] + " - Bank account" + " - " + "Not syndicated\n");
                        }
                        break;
                }
            }
